 ...
 **/
public class FileTransJavaDemoTest {
    // 地域ID，常量内容，请勿改变
    ...
    public FileTransJavaDemoTest(String accessKeyId, String accessKeySecret) {
        //设置endpoint
        try {
    ...
    public static void main(String args[]) throws Exception {
        if (args.length < 3) {
            System.err.println("FileTransJavaDemoTest need params: <AccessKey Id> <AccessKey Secret> <app-key>");
        }
        final String accessKeyId = "LTAIrGfbgw22rzkR";
        final String accessKeySecret = "FtIIXONXH9OE7mOSwtG4CRDUDFrldB";
        final String appKey = "g5PaiI615xfK15Z6";
        String fileLink = "http://demo.faqrobot.net/upload/web/1477617592898263/20191012/761570842505382.mp3";
        FileTransJavaDemoTest demo = new FileTransJavaDemoTest(accessKeyId, accessKeySecret);
